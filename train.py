...
def main():
    ...
    model = Sequential()
    model.add(Conv2D(32, padding='same', kernel_size=(3,3), activation='relu', kernel_regularizer=regularizers.l2(0.01), input_shape=input_shape))
    ...
    with open(os.path.join('pca_data', 'data_{}'.format(str(layer_output.shape[1]))), 'wb') as fi:
